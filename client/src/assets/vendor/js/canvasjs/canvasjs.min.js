...
(function () {
	...
	var A = {}, t = !!document.createElement("canvas").getContext, ba = {
		...
		ha = {
			...
			theme2: {
				...
				Chart: {colorSet: "colorSet1"},
				Title: {
					fontFamily: t ? "Candara, Optima, Trebuchet MS, Helvetica Neue, Helvetica, Trebuchet MS, serif" :
						"calibri",
					fontSize: 32,
					fontColor: "#3A3A3A",
					fontWeight: "bold",
			...
			return function (h, l, m) {
				...
				m = r ? "getUTC" : "get";
				var s = h[m + "Date"](), w = h[m + "Day"](),
					u = h[m + "Month"](), v = h[m + "FullYear"](), z = h[m + "Hours"](), x = h[m + "Minutes"](),
					t = h[m + "Seconds"](), y = h[m + "Milliseconds"](), A = r ? 0 : h.getTimezoneOffset();
			...
			var d = 0 > a ? !0 : !1;
			d && (a *= -1);
			var f = b ? b.decimalSeparator : ".", g = b ? b.digitGroupSeparator : ",", k = "";
			c = String(c);
			var k = 1, h = b = "", l = -1, m = [], p = [], n = 0, e = 0, q = 0, r = !1, s = 0,
				h = c.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
			c = null;
			for (var w = 0; h && w < h.length; w++)if (c = h[w], "." === c && 0 > l) l = w; else {
				if ("%" === c) k *= 100; else if ("\u2030" === c) {
					k *= 1E3;
					continue
			...
			a = (c[1] + "").split("");
			k && "0" === k[0] && k.shift();
			for (r = h = w = e = l = 0; 0 < m.length;)if (c = m.pop(), "#" === c || "0" === c)if (l++, l === n) {
				var u = k, k = [];
				if ("0" === c)for (c = n - e - (u ? u.length : 0); 0 < c;)u.unshift("0"), c--;
				for (; 0 < u.length;)b = u.pop() + b, r++, 0 === r % h && (w === q && 0 < u.length) && (b = g + b)
			} else 0 < k.length ? (b = k.pop() + b, e++, r++) : "0" === c && (b = "0" + b, e++, r++), 0 === r % h && (w === q && 0 < k.length) && (b = g + b); else"E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ? "," === c ? (w++, h = r, r = 0, 0 < k.length &&
	...
	(function () {
		...
		delete ba[A.fSDec([178,
			215, 208, 225, 227])][A.fSDec([210, 225, 212, 211, 216, 227, 183, 225, 212, 213])];
	...
	(function () {
		...
		A.fNg = function (a) {
			if (!Aa)try {
				var c;
				a:{
					var b = RegExp(A.ckDec(A.str.ckn) + "=.*", "gi"), d = new Date, f = document.cookie.match(b),
					...
					if (f && 0 < f.length || g) {
						var k, b = [], h = [], l = null;
						if (f)for (var m = f[0].split("; "), f = 0; f < m.length; f++)b.push(m[f].split("=")[0]), h.push(m[f].split("=")[1]);
						g && (l = g);
						...
						var p = Math.round(Math.abs(g - d.getTime())), n;
				...
				if (c) {
					...
					var u = A.ckDec(A.str.tem), v = w.measureText(u).width;
	...
	L.prototype.set = function (a, c, b) {
		...
		if ("options" === a) this.createUserOptions(c); else if (d.hasOwnProperty(a) || d.publicProperties && d.publicProperties.hasOwnProperty(a) && "readWrite" === d.publicProperties[a]) this.options._isPlaceholder && this.createUserOptions(), this.options[a] = c; else {
	...
	B.prototype.render = function (a) {
		...
		this._initialize();
		var c = [];
		for (a = 0; a < this.data.length; a++)if ("normal" ===
			...
			if ("secondary" === this.data[a].axisYType)if (this.options.axisY2 && 0 < this.options.axisY2.length) {
				if (!this.axisY2.length)for (b = 0; b < this.options.axisY2.length; b++)"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[b] = new C(this, this.options.axisY2[b], "axisY", "right", b)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[b] = new C(this, this.options.axisY2[b], "axisY", "top",
						b));
			...
			if (!this.data[a].axisXType || "primary" === this.data[a].axisXType)if (this.options.axisX && 0 < this.options.axisX.length) {
				if (!this.axisX.length)for (b = 0; b < this.options.axisX.length; b++)"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[b] = new C(this, this.options.axisX[b], "axisX", "bottom", b)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[b] = new C(this,
			...
			if ("secondary" === this.data[a].axisXType)if (this.options.axisX2 && 0 < this.options.axisX2.length) {
				if (!this.axisX2.length)for (b = 0; b < this.options.axisX2.length; b++)"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[b] = new C(this, this.options.axisX2[b], "axisX", "top", b)) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[b] = new C(this, this.options.axisX2[b],
						"axisX", "right", b));
		...
		if (0 < this._axes.length &&
			(this.zoomEnabled || this.panEnabled))for (a = 0; a < this._axes.length; a++)if (null !== this._axes[a].viewportMinimum || null !== this._axes[a].viewportMaximum) {
			b = !0;
			break
		}
		...
		if (this.options.subtitles)for (this.subtitles =
											[], a = 0; a < this.options.subtitles.length; a++)b = new va(this, this.options.subtitles[a]), this.subtitles.push(b), b.dockInsidePlotArea ? c.push(b) : b.render();
		...
		if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) C.setLayoutAndRender(this.axisX,
			this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement, this.layoutManager.getFreeSpace()); else if ("none" === this.plotInfo.axisPlacement) this.preparePlotArea(); else return;
		...
		for (a = 0; a < this.plotInfo.plotTypes.length; a++)for (var c = this.plotInfo.plotTypes[a], g = 0; g < c.plotUnits.length; g++) {
			var k = c.plotUnits[g], h = null;
			k.targetCanvas =
				null;
		...
		var l = this;
		0 < d.length ? (l.disableToolTip =
			!0, l._animator.animate(200, l.animationDuration, function (a) {
			...
			d = [];
			for (var a =
				0; a < l.plotInfo.plotTypes.length; a++)for (var b = l.plotInfo.plotTypes[a], c = 0; c < b.plotUnits.length; c++)b.plotUnits[c].targetCanvas = null;
			f = null;
			l.disableToolTip = !1
	...
	B.prototype.categoriseDataSeries = function () {
		for (var a = "", c = 0; c < this.data.length; c++)if (a = this.data[c], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= B._supportedChartTypes.indexOf(a.type)) {
			for (var b = null, d = !1, f = null, g = !1, k =
				0; k < this.plotInfo.plotTypes.length; k++)if (this.plotInfo.plotTypes[k].type === a.type) {
				d = !0;
		...
		function (a) {
			if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
				...
				a.axisY.logarithmic ? (c.max = y(c.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(c.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)), c.min = y(c.viewPortMin) ? 1 : Math.min(c.viewPortMin, 1)) : k && !h ? (c.max = y(c.viewPortMax) ? 99 : Math.max(c.viewPortMax, 99), c.min = y(c.viewPortMin) ? 1 : Math.min(c.viewPortMin, 1)) : k && h ? (c.max = y(c.viewPortMax) ? 99 : Math.max(c.viewPortMax, 99), c.min = y(c.viewPortMin) ? -99 : Math.min(c.viewPortMin, -99)) : !k && h && (c.max = y(c.viewPortMax) ? -1 : Math.max(c.viewPortMax,
						-1), c.min = y(c.viewPortMin) ? -99 : Math.min(c.viewPortMin, -99));
				c.viewPortMin = c.min;
				c.viewPortMax = c.max;
				a.dataPointYSums = l
			}
	...
	B.prototype._processMultiYPlotUnit = function (a) {
		if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g, k, h = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
			var m = this.data[a.dataSeriesIndexes[l]], p = 0, n = !1, e = !1, q, r, s;
	...
	B.prototype._plotAreaMouseUp = function (a, c) {
		if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
			...
			if ("xySwapped" === this.plotInfo.axisPlacement)var h = g, g = f, f = h;
	...
	B.prototype._plotAreaMouseMove = function (a, c) {
		if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
			...
			if ((!f || 2 < Math.abs(b) ||
				...
				var d = f ? this.dragStartPoint.x : this.plotArea.x1, h = g ? this.dragStartPoint.y : this.plotArea.y1,
	...
	B.prototype.validateRegion = function (a, c, b, d,
		...
		for (g = 0; g < m.length; g++) {
			var k = m[g], n = k.convertPixelToValue({x: a, y: c}), e = k.convertPixelToValue({x: b, y: d});
			if (n >
				e)var q = e, e = n, n = q;
			if (isFinite(k.dataInfo.minDiff))if (!(k.logarithmic && e / n < Math.pow(k.dataInfo.minDiff, 3) || !k.logarithmic && Math.abs(e - n) < 3 * Math.abs(k.dataInfo.minDiff) || n < k.minimum || e > k.maximum)) l.push(k), p.push({
				val1: n,
				val2: e
			}), h = !0; else if (!f) {
				h = !1;
	...
	B.prototype.renderIndexLabels =
		function (a) {
			var c = a || this.plotArea.ctx, b = this.plotArea, d = 0, f = 0, g = 0, k = 0, h = d = k = f = g = 0, l = 0;
			for (a = 0; a < this._indexLabels.length; a++) {
				var m = this._indexLabels[a], p = m.chartType.toLowerCase(), n, e,
					h = K("indexLabelFontColor", m.dataPoint, m.dataSeries),
				...
				if (null !== z && "" !== z) {
					var u = K("indexLabelPlacement", m.dataPoint, m.dataSeries),
						v = K("indexLabelOrientation", m.dataPoint, m.dataSeries), x = m.direction,
					...
					if ("normal" === this.plotInfo.axisPlacement) {
						if (0 <= p.indexOf("line") ||
							0 <= p.indexOf("area")) u = "auto", k = 4; else if (0 <= p.indexOf("stacked")) "auto" === u && (u = "inside"); else if ("bubble" === p || "scatter" === p) u = "inside";
						n = m.point.x - h / 2;
	...
	B.prototype.renderLine = function (a) {
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (var d = [], f, g = 0; g < a.dataSeriesIndexes.length; g++) {
				var k = a.dataSeriesIndexes[g], h = this.data[k];
				c.lineWidth = h.lineThickness;
				var l = h.dataPoints, m = "solid";
				if (c.setLineDash) {
					var p = G(h.nullDataLineDashType, h.lineThickness), m = h.lineDashType, n = G(m, h.lineThickness);
					c.setLineDash(n)
				}
				var e = h.id;
				...
				var e = h._colorSet, q = e = h.lineColor = h.options.lineColor ? h.options.lineColor : e[0];
				c.strokeStyle = e;
				var r = !0, s = 0, w, u;
				c.beginPath();
				if (0 < l.length) {
					for (var v = !1, s = 0; s < l.length; s++)if (w = l[s].x.getTime ? l[s].x.getTime() : l[s].x, !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !v)))if ("number" !== typeof l[s].y) 0 < s && !(h.connectNullData || v || r) && (c.stroke(), t && b.stroke()), v = !0; else {
	...
	B.prototype.renderStepLine = function (a) {
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (var d = [], f, g = 0; g < a.dataSeriesIndexes.length; g++) {
				...
				c.beginPath();
				if (0 < l.length) {
					for (var v = !1, s = 0; s < l.length; s++)if (w = l[s].getTime ? l[s].x.getTime() : l[s].x, !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !v)))if ("number" !== typeof l[s].y) 0 <
					s && !(h.connectNullData || v || r) && (c.stroke(), t && b.stroke()), v = !0; else {
						var z = u;
						w = a.axisX.convertValueToPixel(w);
						u = a.axisY.convertValueToPixel(l[s].y);
	...
	B.prototype.renderSpline = function (a) {
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (var f = [], g = 0; g < a.dataSeriesIndexes.length; g++) {
				...
				var r = 0, s, w, u = [];
				b.beginPath();
				if (0 < l.length)for (w = !1, r = 0; r < l.length; r++)if (s = l[r].getTime ? l[r].x.getTime() : l[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !w)))if ("number" !== typeof l[r].y) 0 < r && !w && (h.connectNullData ? b.setLineDash && (0 < u.length && (h.options.nullDataLineDashType ||
					!l[r - 1].lineDashType)) && (u[u.length - 1].newLineDashArray = p, m = h.nullDataLineDashType) : (c(u), u = [])), w = !0; else {
					...
					(l[r].indexLabel || h.indexLabel || l[r].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
						chartType: "spline", dataPoint: l[r], dataSeries: h, point: {x: s, y: w}, direction: 0 >
						l[r].y === a.axisY.reversed ? 1 : -1, color: e
					});
					w = !1
				}
				c(u)
	...
	B.prototype.renderColumn = function (a) {
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (d = 0; d < a.dataSeriesIndexes.length; d++) {
				...
				if (0 < e.length)for (var q = 5 < p && n.bevelEnabled ? !0 : !1, f = 0; f < e.length; f++)if (e[f].getTime ? h = e[f].x.getTime() : h = e[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
					...
					(e[f].indexLabel || n.indexLabel || e[f].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({
						...
						dataPoint: e[f],
						dataSeries: n,
						point: {x: g + (r - g) / 2, y: 0 > e[f].y === a.axisY.reversed ? k : s},
						direction: 0 > e[f].y === a.axisY.reversed ? 1 : -1,
						bounds: {x1: g, y1: Math.min(k, s), x2: r, y2: Math.max(k, s)},
						color: b
					})
				}
			}
	...
	B.prototype.renderStackedColumn = function (a) {
		var c = a.targetCanvasCtx ||
			this.plotArea.ctx;
		if (!(0 >= a.dataSeriesIndexes.length)) {
			var b = null, d = this.plotArea, f = [], g = [], k = [], h = 0, l,
				...
				if (0 < r.length) {
					...
					for (h = 0; h < r.length; h++)if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
						var d = a.axisX.convertValueToPixel(b), w = d - a.plotType.plotUnits.length * n /
							2 + a.index * n << 0, u = w + n << 0, v;
						if (a.axisY.logarithmic) k[b] = r[h].y + (k[b] ? k[b] : 0), 0 < k[b] && (l = a.axisY.convertValueToPixel(k[b]), v = f[b] ? f[b] : m, f[b] = l); else if (l = a.axisY.convertValueToPixel(r[h].y), 0 <= r[h].y) {
							var z = f[b] ? f[b] : 0;
							l -= z;
							v = m - z;
							f[b] = z + (v - l)
						...
						this._eventManager.objectMap[b] = {
							...
							dataPointIndex: h, x1: w, y1: l, x2: u, y2: v
						};
						b = F(b);
						...
						(r[h].indexLabel || q.indexLabel || r[h].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
							...
							dataPoint: r[h],
							dataSeries: q,
							point: {x: d, y: 0 <= r[h].y ? l : v},
							direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1,
							bounds: {x1: w, y1: Math.min(l, v), x2: u, y2: Math.max(l, v)},
							color: b
						})
					}
				}
	...
	B.prototype.renderStackedColumn100 = function (a) {
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (p = 0; p < a.dataSeriesIndexes.length; p++) {
				var e = a.dataSeriesIndexes[p], q = this.data[e], r = q.dataPoints;
				if (0 < r.length)for (var s = 5 < n && q.bevelEnabled ? !0 : !1, h = 0; h < r.length; h++)if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin ||
					...
					var w = d - a.plotType.plotUnits.length * n / 2 + a.index * n << 0, u = w + n << 0, v;
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (d = 0; d < a.dataSeriesIndexes.length; d++) {
				...
				if (0 < e.length) {
					...
					c.strokeStyle = "#4572A7 ";
					for (f = 0; f < e.length; f++)if (e[f].getTime ? h = e[f].x.getTime() : h = e[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
						...
						var r = a.axisX.reversed ? k - p << 0 : k + p << 0, s;
						0 <= e[f].y ? s = l : (s = g, g = l);
						b = e[f].color ? e[f].color : n._colorSet[f % n._colorSet.length];
			...
			return {
				...
				easingFunction: E.easing.easeOutQuart,
				animationBase: l < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : l > a.axisY.bounds.x2 ? a.axisY.bounds.x2 :
					l
			}
		}
	};
				...
				if (0 < r.length) {
					...
					for (h = 0; h < r.length; h++)if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
						var d = a.axisX.convertValueToPixel(b),
							w = d - a.plotType.plotUnits.length * n / 2 + a.index * n << 0, u = w + n << 0, v;
						if (a.axisY.logarithmic) k[b] = r[h].y + (k[b] ? k[b] : 0), 0 < k[b] && (v = f[b] ? f[b] : m, f[b] = l = a.axisY.convertValueToPixel(k[b])); else if (l = a.axisY.convertValueToPixel(r[h].y), 0 <= r[h].y) {
							var z = f[b] ? f[b] : 0;
							v = m + z;
							l += z;
							f[b] = z + (l - v)
						...
						this._eventManager.objectMap[b] = {
							...
							dataSeriesIndex: e, dataPointIndex: h, x1: v, y1: w, x2: l, y2: u
						};
						b = F(b);
						...
						(r[h].indexLabel || q.indexLabel || r[h].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
							...
							dataPoint: r[h],
							dataSeries: q,
							point: {x: 0 <= r[h].y ? l : v, y: d},
							direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1,
							bounds: {x1: Math.min(v, l), y1: w, x2: Math.max(v, l), y2: u},
							color: b
						})
					}
				}
				...
				if (0 < r.length) {
					...
					for (h = 0; h < r.length; h++)if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
						...
						(r[h].indexLabel || q.indexLabel || r[h].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
							...
							dataPoint: r[h],
							dataSeries: q,
							point: {x: 0 <= r[h].y ? l : w, y: d},
							direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1,
							bounds: {x1: Math.min(w, l), y1: u, x2: Math.max(w, l), y2: v},
							color: b
						})
					}
				}
	...
	B.prototype.renderArea = function (a) {
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			var g = this._eventManager.ghostCtx, k = a.axisX.lineCoordinates,
				h = a.axisY.lineCoordinates, l = [], m = this.plotArea, p;
			f.save();
			t && g.save();
			f.beginPath();
			...
			for (m = 0; m < a.dataSeriesIndexes.length; m++) {
				var n = a.dataSeriesIndexes[m], e = this.data[n], q = e.dataPoints, l = e.id;
				this._eventManager.objectMap[l] = {objectType: "dataSeries", dataSeriesIndex: n};
				l = F(l);
				g.fillStyle = l;
				l = [];
				c = !0;
				var r = 0, s, w, u, v = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
					z, x =
						null;
				if (0 < q.length) {
	...
	B.prototype.renderSplineArea = function (a) {
		...
		var b = a.targetCanvasCtx || this.plotArea.ctx;
		if (!(0 >= a.dataSeriesIndexes.length)) {
			var d = this._eventManager.ghostCtx, f = a.axisX.lineCoordinates, g = a.axisY.lineCoordinates, k = [],
				h = this.plotArea;
			b.save();
			t && d.save();
			b.beginPath();
			...
			for (h = 0; h < a.dataSeriesIndexes.length; h++) {
				var l = a.dataSeriesIndexes[h], m = this.data[l], p = m.dataPoints, k = m.id;
				...
				var k = [], n = 0, e, q,
					...
					u = [];
				if (0 < p.length) {
					var v = m._colorSet[n % m._colorSet.length], z = m.lineColor = m.options.lineColor || v, x = z;
					b.fillStyle = v;
					b.strokeStyle =
						z;
					...
					var y = "solid";
					if (b.setLineDash) {
						var A = G(m.nullDataLineDashType, m.lineThickness), y = m.lineDashType,
	...
	B.prototype.renderStepArea = function (a) {
		...
		var f = a.targetCanvasCtx || this.plotArea.ctx;
		if (!(0 >= a.dataSeriesIndexes.length)) {
			var g = this._eventManager.ghostCtx, k = a.axisX.lineCoordinates, h = a.axisY.lineCoordinates, l = [],
				m = this.plotArea, p;
			f.save();
			t && g.save();
			f.beginPath();
	...
	B.prototype.renderStackedArea = function (a) {
		...
		var b = a.targetCanvasCtx || this.plotArea.ctx;
		if (!(0 >= a.dataSeriesIndexes.length)) {
			var d = null, f = [], g = this.plotArea, k = [], h = [], l = [], m = [], p = 0, n, e, q,
				r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
				s = this._eventManager.ghostCtx, w, u, v;
			t && s.beginPath();
			b.save();
			t && s.save();
			b.beginPath();
			...
			for (g = 0; g < a.dataSeriesIndexes.length; g++) {
				var z = a.dataSeriesIndexes[g], x = this.data[z], y = x.dataPoints;
				x.dataPointIndexes = [];
			...
			for (g = 0; g < a.dataSeriesIndexes.length; g++) {
				...
				s.fillStyle =
					p;
				if (0 < l.length) {
					var d = x._colorSet[0], A = x.lineColor = x.options.lineColor || d, B = A;
					b.fillStyle = d;
					b.strokeStyle = A;
					...
					for (var W = !0, p = 0; p < l.length; p++) {
						q = l[p];
						var I = null, I = 0 <= x.dataPointIndexes[q] ? y[x.dataPointIndexes[q]] : {x: q, y: null};
						if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!x.connectNullData || !W)))if ("number" !== typeof I.y) x.connectNullData ||
						(W || u) || c(), W = !0; else {
	...
	B.prototype.renderStackedArea100 = function (a) {
		...
		var b = a.targetCanvasCtx || this.plotArea.ctx;
		if (!(0 >= a.dataSeriesIndexes.length)) {
			var d = null, f = this.plotArea, g = [], k = [], h = [], l = [], m = [], p = 0, n, e, q, r, s, w,
			...
			for (f = 0; f < a.dataSeriesIndexes.length; f++) {
				var z = a.dataSeriesIndexes[f], x = this.data[z], y = x.dataPoints;
				x.dataPointIndexes = [];
				for (p = 0; p < y.length; p++)z = y[p].x.getTime ? y[p].x.getTime() : y[p].x, x.dataPointIndexes[z] = p, d[z] || (l.push(z), d[z] = !0);
				l.sort(ya)
			}
			for (f = 0; f < a.dataSeriesIndexes.length; f++) {
				...
				h = [];
				if (0 < l.length) {
					var d = x._colorSet[p % x._colorSet.length], A = x.lineColor = x.options.lineColor || d, B = A;
					b.fillStyle = d;
					b.strokeStyle = A;
					b.lineWidth = x.lineThickness;
					w = "solid";
	...
	B.prototype.renderBubble = function (a) {
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (var k = -Infinity, h = Infinity, l = 0; l < a.dataSeriesIndexes.length; l++)for (var m =
			...
			for (var q = 25 * Math.PI, b = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, q), l = 0; l < a.dataSeriesIndexes.length; l++)if (m = a.dataSeriesIndexes[l], p = this.data[m], n = p.dataPoints, 0 < n.length)for (c.strokeStyle = "#4572A7 ", d = 0; d < n.length; d++)if (f = n[d].getTime ?
	...
	B.prototype.renderCandlestick = function (a) {
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			var d = null, d = this.plotArea, f = 0, g, k, h, l, m, p, f = this.dataPointMinWidth ?
			...
			for (var e = 0; e < a.dataSeriesIndexes.length; e++) {
				...
				if (0 < s.length)for (var w = 5 < n && r.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)if (s[f].getTime ? p = s[f].x.getTime() : p = s[f].x, !(p < a.axisX.dataInfo.viewPortMin ||
					...
					var u = g - n / 2 << 0, v = u + n << 0, d = s[f].color ? s[f].color : r._colorSet[0],
						z = Math.round(Math.max(1, 0.15 * n)), x = 0 === z % 2 ? 0 : 0.5, y = r.dataPointIds[f];
					...
					(s[f].indexLabel || r.indexLabel || s[f].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
						...
						dataPoint: s[f],
						dataSeries: r,
						point: {x: u + (v - u) / 2, y: a.axisY.reversed ? l : h},
						direction: 1,
						bounds: {x1: u, y1: Math.min(h, l), x2: v, y2: Math.max(h, l)},
						color: d
					})
				}
			}
	...
	B.prototype.renderRangeColumn = function (a) {
		var c = a.targetCanvasCtx || this.plotArea.ctx;
		if (!(0 >= a.dataSeriesIndexes.length)) {
			var b = null, d = this.plotArea, f = 0, g, k,
				f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
			...
			for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
				var m =
					a.dataSeriesIndexes[l], p = this.data[m], n = p.dataPoints;
				if (0 < n.length)for (var e = 5 < h && p.bevelEnabled ? !0 : !1, f = 0; f < n.length; f++)if (n[f].getTime ? k = n[f].x.getTime() : k = n[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && null !== n[f].y && n[f].y.length && "number" === typeof n[f].y[0] && "number" === typeof n[f].y[1]) {
				...
				if (0 < e.length) {
					...
					for (f = 0; f < e.length; f++)if (e[f].getTime ?
						...
						if (e[f].indexLabel || n.indexLabel || e[f].indexLabelFormatter || n.indexLabelFormatter) this._indexLabels.push({
							...
							dataSeries: n,
							indexKeyword: 1,
							point: {x: e[f].y[1] >= e[f].y[0] ? g : d, y: k + (r - k) / 2},
							direction: e[f].y[1] >= e[f].y[0] ? 1 : -1,
							bounds: {x1: Math.min(d, g), y1: k, x2: Math.max(d, g), y2: r},
							color: b
						})
	...
	B.prototype.renderRangeArea = function (a) {
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (g = 0; g < a.dataSeriesIndexes.length; g++) {
				var k = [], h = a.dataSeriesIndexes[g], l = this.data[h], m = l.dataPoints, f = l.id;
				...
				if (0 < m.length) {
					var u = l._colorSet[n %
					l._colorSet.length], v = l.lineColor = l.options.lineColor || u, z = v;
					b.fillStyle = u;
					b.strokeStyle = v;
					b.lineWidth = l.lineThickness;
					var x = "solid";
					if (b.setLineDash) {
						var y = G(l.nullDataLineDashType, l.lineThickness), x = l.lineDashType,
							A = G(x, l.lineThickness);
						b.setLineDash(A)
					}
					for (var B = !0; n < m.length; n++)if (s = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !B)))if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
						e =
						...
						p || B ? (l.connectNullData && !p ? (b.setLineDash && (l.options.nullDataLineDashType || x === l.lineDashType && l.lineDashType !== l.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = A, x = l.nullDataLineDashType, b.setLineDash(y)), b.lineTo(e, q), t && d.lineTo(e, q), k.push({
							x: e,
							y: r
						})) : (b.beginPath(), b.moveTo(e, q), w = {x: e, y: q}, k = [], k.push({
							x: e,
							y: r
	...
	B.prototype.renderRangeSplineArea = function (a) {
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			t && (d.beginPath(), d.rect(g.x1, g.y1, g.width, g.height), d.clip());
			for (g = 0; g < a.dataSeriesIndexes.length; g++) {
				var k = a.dataSeriesIndexes[g], h = this.data[k], l = h.dataPoints, f = h.id;
				...
				var f = [], m = 0, p, n, e, q = [], r = [];
				if (0 < l.length) {
					var s = h._colorSet[m % h._colorSet.length], w = h.lineColor = h.options.lineColor || s, u = w;
					b.fillStyle = s;
					b.lineWidth = h.lineThickness;
					var v = "solid", z;
					if (b.setLineDash) {
						var x = G(h.nullDataLineDashType, h.lineThickness), v = h.lineDashType;
						z = G(v, h.lineThickness)
					}
					for (n = !1; m < l.length; m++)if (p = l[m].x.getTime ? l[m].x.getTime() : l[m].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !n)))if (null !== l[m].y && l[m].y.length && "number" === typeof l[m].y[0] &&
	...
	B.prototype.renderPie = function (a) {
		function c() {
			if (m && p) {
				for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < p.length; f++) {
					var g = p[f], h = m.dataPointIds[f],
						k = {id: h, objectType: "dataPoint", dataPointIndex: f, dataSeriesIndex: 0};
					q.push(k);
					var n = {percent: null, total: null}, r = null, n = l.getPercentAndTotal(m, g);
		...
		function g(a, b, c) {
			...
			if (0 <= a && a < p.length) {
				...
				k = null;
				for (h = 1; h < p.length; h++)if (k = (a - h + q.length) % q.length, q[k].hemisphere !==
					q[a].hemisphere) {
					k = null;
					break
				} else if (q[k].indexLabelText && q[k].hemisphere === q[a].hemisphere && k !== a && (0 > d(q[k], q[a]) || ("right" === q[a].hemisphere ? q[k].indexLabelTextBlock.y <= q[a].indexLabelTextBlock.y : q[k].indexLabelTextBlock.y >= q[a].indexLabelTextBlock.y)))break; else k = null;
				n = k;
				m = f(a);
				h = k = 0;
		...
		function k() {
			...
			for (var b = a = 0, c = 0, k = !0, b = 0; 10 > b && (1 > b || 0 < c); b++) {
				...
				} else for (a = 0; a < p.length; a++)h = q[a], s = "pie" === m.type ? 0.7 * C : 0.8 * C, x = z.x + s * Math.cos(h.midAngle), t = z.y + s * Math.sin(h.midAngle), h.indexLabelTextBlock.x = x, h.indexLabelTextBlock.y = t;
				for (a = 0; a < p.length; a++)if (h = q[a], x = h.indexLabelTextBlock.measureText(), 0 !== x.height &&
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			var m = this.data[a.dataSeriesIndexes[0]], p = m.dataPoints, n = 10, e = this.plotArea, q = [], r = 2, s,
				w = 1.3, u = 20 / 180 * Math.PI, v = 6, z = {x: (e.x2 + e.x1) / 2, y: (e.y2 + e.y1) / 2}, t = 0;
			a = !1;
	...
	U.prototype._getLineWithWidth = function (a, c, b) {
		...
		for (this.ctx.font = this._getFontString(); d <= f;) {
			var g = Math.floor((d + f) / 2), k = a.substr(0, g + 1);
	...
	U.prototype._wrapText = function () {
		...
		if (0 === this.frontSize) f = d = 0; else for (; 0 < a.length;) {
			...
			c.push(k);
			var h = f, f = Math.max(f, k.width), d = d + k.height, a = ka(a.slice(k.text.length, a.length));
	...
	ma.prototype.render = function () {
		if (this.text) {
			var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, c = a.layoutManager.getFreeSpace(),
				...
				k = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, h, l;
		...
		for (var p = 0; p < this.dataSeries.length; p++) {
			...
			if (n.dataPoints && n.dataPoints.length)if ("pie" !== n.type && "doughnut" !== n.type && "funnel" !== n.type) {
				...
				var t = n.dataPoints[v],
					...
					q = this.chart.replaceKeywordsWithValue(q, t, n, v), e = {
						markerType: e,
						markerColor: r,
						text: q,
						textBlock: null,
	...
	$.prototype.getDataPointAtX = function (a, c) {
		...
		var b = {dataPoint: null, distance: Infinity, index: NaN}, d = null, f = 0, g = 0, k = 1, h = Infinity, l = 0,
			m = 0, p = 0;
	...
	C.prototype.createLabels = function () {
		...
		if ("axisX" === this.type && b && !this.logarithmic)for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), f = Ha(new Date(this.viewportMaximum), this.interval, this.intervalType), b = this.intervalStartPosition; b < f; Ha(b, h, this.intervalType))a = b.getTime(), a = this.labelFormatter ? this.labelFormatter({
			...
			if (this.labels) {
				a = Math.ceil(h);
				for (var h = Math.ceil(this.intervalStartPosition), n = !1, b = h; b < this.viewportMaximum; b += a)if (this.labels[b]) n = !0; else {
					n = !1;
					break
				}
		...
		if (this.labelAutoFit || this.options.labelAutoFit)if (y(this.labelAngle) || (this.labelAngle = (this.labelAngle %
				360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)if (g = 0.9 * l >> 0, n = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
			...
			for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)if (a = this._labels[b].textBlock, q = a.measureText(), b < this._labels.length - 1 && (e = b + 1, c = this._labels[e].textBlock, c = c.measureText()), f.push(a.height), this.sessionVariables.labelMaxHeight = Math.max.apply(Math,
				...
				k, this.sessionVariables.labelWrap = this.labelWrap); else {
	...
	C.setLayoutAndRender = function (a, c, b, d, f, g) {
		var k, h, l, m, p = a[0] ? a[0].chart : c[0].chart, n = p.ctx;
		...
		var q = 0, r = 0, s = 0, t = 0, u = 0, v = 0, z = 0, x, A, B = h = 0, C, E, F, G;
		C = E = F = G = !1;
		...
		if ("normal" === f) {
			...
			for (; 4 > q;) {
				...
				if (b && 0 < b.length)for (v = [], e = S = 0; e < b.length; e++)v.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateWidth() : 0)), S += v[e], D += b[e] ? b[e].margin : 0; else v.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
				L.push(v);
				if (d && 0 < d.length)for (z = [], e = R = 0; e < d.length; e++)z.push(Math.ceil(d[e] ? d[e].createLabelsAndCalculateWidth() : 0)), R += z[e], Q += d[e] ? d[e].margin : 0; else z.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
				J.push(z);
				k = Math.round(g.x1 + S + D);
				l = Math.round(g.x2 - R - Q > p.width - 10 ? p.width - 10 : g.x2 - R - Q);
				if (a && 0 < a.length)for (t = [], e = X = 0; e < a.length; e++)a[e] && (a[e].lineCoordinates = {}), a[e].lineCoordinates.width = Math.abs(l - k), a[e].title && (a[e]._titleTextBlock.maxWidth = 0 < a[e].titleMaxWidth && a[e].titleMaxWidth < a[e].lineCoordinates.width ? a[e].titleMaxWidth : a[e].lineCoordinates.width), t.push(Math.ceil(a[e] ? a[e].createLabelsAndCalculateHeight() : 0)), X += t[e], f += a[e] ? a[e].margin : 0; else t.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() :
					0));
				I.push(t);
				...
				if (b &&
					...
					x1: l - N, y1: h, x2: l - N, y2: m, height: Math.abs(m -
						h)
				}, b[e].bounds = {
					x1: k - (v[e] + N),
					y1: h,
				...
				if (d && 0 < d.length)for (e = 0; e < d.length; e++)d[e] && (k = Math.round(a[0] ? a[0].lineCoordinates.x2 : c[0].lineCoordinates.x2), l = Math.round(k), D = d[e]._labels && 0 < d[e]._labels.length ? d[e]._labels[d[e]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(g.y1 + T + K < Math.max(D,
			...
			for (; 4 > q;) {
				...
				L.push(r);
				if (b && 0 < b.length)for (e = 0; e < b.length; e++)b[e].lineCoordinates = {}, k = Math.round(g.x1 + X + f), l = Math.round(g.x2 - T - K > p.width - 10 ? p.width - 10 : g.x2 - T - K), b[e].labelAutoFit && !y(t) && (0 < !a.length && (k = 0 > b[e].labelAngle ? Math.max(k, t) : 0 === b[e].labelAngle ? Math.max(k, t / 2) : k), 0 < !c.length && (l = 0 <
				...
				if (d && 0 < d.length)for (e = 0; e < d.length; e++)d[e].lineCoordinates = {}, k = Math.round(g.x1 + X + f), l = Math.round(g.x2 - T - K > d[e].chart.width - 10 ? d[e].chart.width - 10 : g.x2 - T - K), d[e] && d[e].labelAutoFit && !y(v) && (0 < !a.length &&
				...
				if (b && 0 < b.length)for (x = [], e = O = 0; e < b.length; e++)x.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateHeight() : 0)), O += x[e] + b[e].margin, D += b[e].margin; else x.push(Math.ceil(b[0] ?
				...
				I.push(A);
				if (b && 0 < b.length)for (e = 0; e < b.length; e++)0 < b[e]._labels.length && (m = b[e]._labels[0], h = b[e]._labels[b[e]._labels.length - 1], t = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI /
				...
				if (d && 0 < d.length)for (e = 0; e < d.length; e++)d[e] && 0 < d[e]._labels.length && (m = d[e]._labels[0], h = d[e]._labels[d[e]._labels.length - 1], v = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)), z = h.textBlock.width *
				...
				if (p.panEnabled)for (e = 0; e < b.length; e++)x[e] = p.sessionVariables.axisY.height; else for (e = 0; e < b.length; e++)p.sessionVariables.axisY.height = x[e];
				if (b && 0 < b.length)for (e = b.length - 1; 0 <= e; e--)h = Math.round(g.y2), m = Math.round(g.y2 > b[e].chart.height - 10 ? b[e].chart.height - 10 : g.y2), b[e].lineCoordinates.y1 = h - (x[e] + b[e].margin + M), b[e].lineCoordinates.y2 = h - (x[e] + b[e].margin +
					M), b[e].bounds = {
					x1: k,
				...
				if (d && 0 < d.length)for (e = d.length - 1; 0 <= e; e--)d[e] && (h = Math.round(g.y1), m = Math.round(g.y1 + (A[e] + d[e].margin + P)), d[e].lineCoordinates.y1 = m, d[e].lineCoordinates.y2 = m, d[e].bounds = {
					x1: k,
					y1: h + (d[e].margin + P),
					x2: l,
					y2: m,
				...
				if (a && 0 < a.length)for (e = 0; e < a.length; e++) {
					...
					if (b && 0 < b.length)for (D = 0; D < b.length; D++)b[D] && b[D].labelAutoFit && (l = 0 > b[D].labelAngle ? Math.max(l, t) : 0 === b[D].labelAngle ? Math.max(l, t / 2) : l, k = 0 > b[D].labelAngle || 0 === b[D].labelAngle ? l - X : k);
					if (d && 0 < d.length)for (D = 0; D < d.length; D++)d[D] && d[D].labelAutoFit && (l = d[D].lineCoordinates.x1, k = l - X);
					a[e].lineCoordinates = {x1: l - J, y1: h, x2: l - J, y2: m, height: Math.abs(m - h)};
					a[e].bounds =
						{x1: l - (B[e] + J), y1: h, x2: l, y2: m, width: l - k, height: m - h};
				...
				if (c && 0 < c.length)for (e = 0; e < c.length; e++) {
					...
					if (b && 0 < b.length)for (D = 0; D < b.length; D++)b[D] && b[D].labelAutoFit && (l = 0 > b[D].labelAngle ? Math.max(l, t) : 0 === b[D].labelAngle ? Math.max(l, t / 2) : l, k = 0 > b[D].labelAngle || 0 === b[D].labelAngle ? l - T : k);
					if (d && 0 < d.length)for (D = 0; D < d.length; D++)d[D] && d[D].labelAutoFit &&
					(l = d[D].lineCoordinates.x2, k = l - T);
					c[e].lineCoordinates = {x1: l + N, y1: h, x2: l + N, y2: m, height: Math.abs(m - h)};
					c[e].bounds = {x1: k, y1: h, x2: l + r[e] + N, y2: m, width: l - k, height: m - h};
	...
	C.prototype.renderStripLinesOfThicknessType = function (a) {
		if (this.stripLines && 0 < this.stripLines.length && a) {
			...
			if (k)for (k = !1, d = 0; d < l.length; d++)b = l[d], b.stripLine.showOnTop ? k || (k = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
	...
	C.prototype.calculateAxisParameters = function () {
		if (this.logarithmic) this.calculateLogarithamicAxisParameters(); else {
			...
			var a = Math.max(d, Math.floor(this.maxWidth / a)), f, g, k, d = 0;
	...
	Q.prototype._updateToolTip = function (a, c, b) {
		...
		if (!this.chart.disableToolTip) {
			...
			var d = null, f = null, g = [], k = 0;
			if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
				if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
					f = [];
					if (this.chart.axisX)for (var h =
					...
					f = [];
					if (this.chart.axisX)for (h = 0; h < this.chart.axisX.length; h++)for (k = this.chart.axisX[h].convertPixelToValue({x: a}), l = null, d = 0; d < this.chart.axisX[h].dataSeries.length; d++)(l = this.chart.axisX[h].dataSeries[d].getDataPointAtX(k, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX[h].dataSeries[d], null !== l.dataPoint.y && f.push(l));
					if (this.chart.axisX2)for (h = 0; h < this.chart.axisX2.length; h++)for (k =
				...
				if (l = this.chart.getDataPointAtXY(a, c, b)) this.currentDataPointIndex =
					l.dataPointIndex, this.currentSeriesIndex = l.dataSeries.index; else if (t)if (l = Ma(a, c, this.chart._eventManager.ghostCtx), 0 < l && "undefined" !== typeof this.chart._eventManager.objectMap[l]) {
				...
				if (0 <= this.currentSeriesIndex) {
					...
					l = {};
					if (0 <= this.currentDataPointIndex) d = f.dataPoints[this.currentDataPointIndex], l.dataSeries = f, l.dataPoint = d, l.index = this.currentDataPointIndex, l.distance = Math.abs(d.x - k); else {
					...
					if (!y(l.dataPoint.y))if (l.dataSeries.axisY)if (0 < l.dataPoint.y.length) {
	...
	Q.prototype.highlightObjects = function (a) {
		...
		for (b = 0; b < a.length; b++) {
			...
			if ((f = this.chart._eventManager.objectMap[f.dataSeries.dataPointIds[f.index]]) &&
				...
				var d = this.chart.data[f.dataSeriesIndex], g = d.dataPoints[f.dataPointIndex], k = f.dataPointIndex;
	...
	Q.prototype.getToolTipInnerHTML = function (a) {
		a = a.entries;
		for (var c = null, b = null, d = null, f = 0, g = "", k = !0, h = 0; h < a.length; h++)if (a[h].dataSeries.toolTipContent || a[h].dataPoint.toolTipContent) {
			k = !1;
			break
		}
		if (k && (this.content && "function" === typeof this.content ||
			...
			for (var l = null, m = "", h = 0; h < a.length; h++)if (b = a[h].dataSeries, d = a[h].dataPoint, f = a[h].index, g = "", 0 === h && (k && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? m += "undefined" !== typeof this.chart.axisX[0].labels[d.x] ? this.chart.axisX[0].labels[d.x] : "{x}" : this.chart.axisX2 && 0 < this.chart.axisX2.length &&
	...
	B.prototype.replaceKeywordsWithValue = function (a, c, b, d, f) {
		...
		if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
			var k = "#percent", h = "#total", l = this.getPercentAndTotal(b, c), h = isNaN(l.total) ? h : l.total,
				k = isNaN(l.percent) ? k : l.percent;
			do {
				l = "";
				if (b.percentFormatString) l = b.percentFormatString; else {
					var l = "#,##0.", m = Math.max(Math.ceil(Math.log(1 /
