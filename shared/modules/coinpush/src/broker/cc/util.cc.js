...
exports.CCC = {};
exports.CCC.STATIC = exports.CCC.STATIC || {};
exports.CCC.STATIC.TYPE = {
    'TRADE': '0',
    'FEEDNEWS': '1',
    'CURRENT': '2§§',
    'LOADCOMPLETE': '3',
...
exports.CCC.STATIC.CURRENCY = exports.CCC.STATIC.CURRENCY || {};
exports.CCC.STATIC.CURRENCY.SYMBOL = {
    'BTC': 'Ƀ',
    'LTC': 'Ł',
    'DAO': 'Ð',
    'USD': '$',
...
exports.CCC.STATIC.CURRENCY.getSymbol = function (symbol) {
    return exports.CCC.STATIC.CURRENCY.SYMBOL[symbol] || symbol;
};
exports.CCC.STATIC.UTIL = {
    exchangeNameMapping: {
    ...
    convertCurrentKeyToAll: function (key) {
        ...
        valuesArray[0] = exports.CCC.STATIC.TYPE.CURRENTAGG;
        valuesArray[1] = 'CCCAGG';
        return valuesArray.join('~');
    },
    convertCurrentKeyToTrade: function (key) {
        var valuesArray = key.split("~");
        valuesArray[0] = exports.CCC.STATIC.TYPE.TRADE;
        return valuesArray.join('~');
    },
...
exports.CCC.TRADE = exports.CCC.TRADE || {};
/*
trade fields binary values always in the last ~
*/
exports.CCC.TRADE.FLAGS = {
...
exports.CCC.TRADE.DISPLAY = exports.CCC.TRADE.DISPLAY || {};
exports.CCC.TRADE.DISPLAY.FIELDS = {
    'T': { "Show": false },
...
exports.CCC.TRADE.pack = function (tradeObject) {
    var mask = 0;
    var packedTrade = '';
...
exports.CCC.TRADE.unpack = function (tradeString) {
...
exports.CCC.CURRENT.DISPLAY = exports.CCC.CURRENT.DISPLAY || {};
exports.CCC.CURRENT.DISPLAY.FIELDS = {
    'TYPE': { 'Show': false },
...
exports.CCC.CURRENT.pack = function (currentObject) {
    var mask = 0;
    var packedCurrent = '';
    for (var property in this.FIELDS) {
...
exports.CCC.CURRENT.unpack = function (value) {
...
exports.CCC.CURRENT.getKey = function (currentObject) {
    return currentObject['TYPE'] + '~' + currentObject['MARKET'] + '~' + currentObject['FROMSYMBOL'] + '~' + currentObject['TOSYMBOL'];
};
exports.CCC.CURRENT.getKeyFromStreamerData = function (streamerData) {
    var valuesArray = streamerData.split("~");
    return valuesArray[0] + '~' + valuesArray[1] + '~' + valuesArray[2] + '~' + valuesArray[3];
};
exports.CCC.FULLVOLUME = exports.CCC.FULLVOLUME || {};
exports.CCC.FULLVOLUME.FIELDS = {
    'TYPE': 0x0,
    'SYMBOL': 0x0,
    'FULLVOLUME': 0x0
};
exports.CCC.FULLVOLUME.unpack = function (volStr) {
...
exports.CCC.FULLVOLUME.pack = function (volObj) {
    var packedVol = '';
    var fields = this.FIELDS;
    for (var property in fields) {
...
exports.CCC.noExponents = function (value) {
    var data = String(value).split(/[eE]/);
    if (data.length == 1)
        return data[0];
    var z = '', sign = value < 0 ? '-' : '', str = data[0].replace('.', ''), mag = Number(data[1]) + 1;
...
exports.CCC.filterNumberFunctionPolyfill = function (value, decimals) {
...
exports.CCC.convertValueToDisplay = function (symbol, value, type, fullNumbers) {
    var prefix = '';
    var valueSign = 1;
    value = parseFloat(value);
    var valueAbs = Math.abs(value);
    ...
    if (type == "short") {
        if (valueAbs > 10000000000) {
            valueAbs = valueAbs / 1000000000;
            return prefix + exports.CCC.filterNumberFunctionPolyfill(valueSign * valueAbs, decimalsOnBigNumbers) + ' B';
        }
        if (valueAbs > 10000000) {
            valueAbs = valueAbs / 1000000;
            return prefix + exports.CCC.filterNumberFunctionPolyfill(valueSign * valueAbs, decimalsOnBigNumbers) + ' M';
        }
        if (valueAbs > 10000) {
            valueAbs = valueAbs / 1000;
            return prefix + exports.CCC.filterNumberFunctionPolyfill(valueSign * valueAbs, decimalsOnBigNumbers) + ' K';
        }
        if (valueAbs >= 1) {
            return prefix + exports.CCC.filterNumberFunctionPolyfill(valueSign * valueAbs, decimalsOnNormalNumbers);
        }
        return prefix + (valueSign * valueAbs).toPrecision(decimalsOnSmallNumbers);
    }
    else {
