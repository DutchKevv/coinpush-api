...
var util_config_1 = require("../util/util-config");
var BrokerMiddleware = /** @class */ (function (_super) {
    ...
    BrokerMiddleware.prototype.getSymbols = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.all([this._brokers.cc.getSymbols()])];
                    case 1:
                        results = _a.sent();
    ...
    BrokerMiddleware.prototype.splitSymbolsToBrokers = function (symbols) {
        return {
            oanda: symbols.filter(function (symbol) { return symbol.broker === constants_1.BROKER_GENERAL_TYPE_OANDA; }),
            cc: symbols.filter(function (symbol) { return symbol.broker === constants_1.BROKER_GENERAL_TYPE_CC; }),
            iex: symbols.filter(function (symbol) { return symbol.broker === constants_1.BROKER_GENERAL_TYPE_IEX; })
        };
    };
